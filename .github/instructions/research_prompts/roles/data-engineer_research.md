# Research: Role: Data Engineer

Research specifically the Data Engineer role in GitHub Copilot:

REQUIRED ANALYSIS:
1. BEST PRACTICES (5 specific)
   - VS Code configurations optimized for data-engineer
...
2. CRITICAL ANTI-PATTERNS (5 critical)
   - Common instruction errors for data-engineer
...
OBJECTIVE: Maximize data-engineer role productivity
