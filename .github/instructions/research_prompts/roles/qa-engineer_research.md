# Research: Role: QA Engineer

Research specifically the QA Engineer role in GitHub Copilot:

REQUIRED ANALYSIS:
1. BEST PRACTICES (5 specific)
   - VS Code configurations optimized for qa-engineer
...
2. CRITICAL ANTI-PATTERNS (5 critical)
   - Common instruction errors for qa-engineer
...
OBJECTIVE: Maximize qa-engineer role productivity
