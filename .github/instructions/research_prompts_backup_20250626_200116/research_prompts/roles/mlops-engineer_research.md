# Investigación: Rol: Mlops Engineer


Investiga específicamente el rol de Mlops Engineer en GitHub Copilot:

ANÁLISIS REQUERIDO:
1. MEJORES PRÁCTICAS (5 específicas)
   - Configuraciones VS Code optimizadas para mlops-engineer
...
2. ANTI-PATTERNS CRÍTICOS (5 críticos)
   - Errores comunes en instrucciones para mlops-engineer
...
OBJETIVO: Maximizar productividad del rol mlops-engineer
