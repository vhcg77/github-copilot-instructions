# Investigación: Rol: Data Engineer


Investiga específicamente el rol de Data Engineer en GitHub Copilot:

ANÁLISIS REQUERIDO:
1. MEJORES PRÁCTICAS (5 específicas)
   - Configuraciones VS Code optimizadas para data-engineer
...
2. ANTI-PATTERNS CRÍTICOS (5 críticos)
   - Errores comunes en instrucciones para data-engineer
...
OBJETIVO: Maximizar productividad del rol data-engineer
